...
// Most efficient approach. Very fast and able to process very large
// numbers.
//
// This solution will Factor prime numbers used to generate each number
// in series and compute the smallest dividend evenly divisible by the
// entire series. The analysis uses big.Int and is capable of processing
// very large numbers.
//
